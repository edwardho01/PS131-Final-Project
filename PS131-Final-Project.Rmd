...
```{r message=FALSE, warning=FALSE, include=FALSE}
accidents_data <- read_csv("D:/UCSB/PSTAT131/Final Project/data/accidents1.csv")
```
...
write_rds(accidents_train,"D:/UCSB/PSTAT131/Final Project/data/processed\\accidents_train.rds")
```
...
accidents_folds <- vfold_cv(accidents_train, v=10, repeats = 2,strata=severity)
...
write_rds(accidents_train,"D:/UCSB/PSTAT131/Final Project/data/processed\\accidents_train.rds")
save(accidents_folds,accidents_recipe,accidents_train,file = "D:/UCSB/PSTAT131/Final Project/data/model_fitting/model_setup.rda")
```
...
save(log_wkflow,file = "D:/UCSB/PSTAT131/Final Project/data/model_fitting/log_model.rda")
```
...
class_tree_param_grid <- grid_regular(cost_complexity(range = c(-6, -1)), levels = 5)
...
save(class_tree_wf,class_tree_tune_res,file = "D:/UCSB/PSTAT131/Final Project/data/model_fitting/class_tree_model.rda")
```
...
rf_param_grid <- grid_regular(mtry(range = c(1,16)),trees(range = c(100,500)),min_n(range = c(1,16)),levels = c(5,5,5))
...
save(rf_spec_wf,rf_tune_res,file = "D:/UCSB/PSTAT131/Final Project/data/model_fitting/rf_model.rda")
```
...
save(boost_spec_wf,boost_tune_res,file = "D:/UCSB/PSTAT131/Final Project/data/model_fitting/boost_model.rda")
```
...
```{r}
load("D:/UCSB/PSTAT131/Final Project/data/model_fitting/model_setup.rda")
load("D:/UCSB/PSTAT131/Final Project/data/model_fitting/log_model.rda")
load("D:/UCSB/PSTAT131/Final Project/data/model_fitting/class_tree_model.rda")
load("D:/UCSB/PSTAT131/Final Project/data/model_fitting/rf_model.rda")
load("D:/UCSB/PSTAT131/Final Project/data/model_fitting/boost_model.rda")
```
